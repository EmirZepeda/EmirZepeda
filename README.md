 ...
 **Full-Stack Developer con mentalidad de alto rendimiento.**  
 **Transformo ideas en código eficiente, escalable y robusto.**  
 **Frontend lover:** UI/UX limpios con **Material UI & TailwindCSS**.  
 **Backend geek:** Arquitecturas modernas con **Node.js, NestJS & Databases**.  
 Siempre en busca de **microservicios, DevOps y optimización hardcore**.  
